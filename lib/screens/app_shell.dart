...
class _AppShellState extends State<AppShell>
  ...
  Widget _buildBottomNav(BuildContext context) {
    ...
    final podcastsShown = _podcastsShown(lib);
    final labels = _buildTabLabels(context, podcastsShown);
    final tabIndex = _selectedDest(lib, podcastsShown);
  ...
  List<String> _buildTabLabels(BuildContext context, bool podcastsShown) {
